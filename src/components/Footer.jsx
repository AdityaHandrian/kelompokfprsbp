      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="mb-4">
            ...
            <h3 className="text-xl font-bold text-white">Product Recommendation System Demo</h3>
          </div>
          ...
          <div className="border-t border-gray-700 pt-4">
            <p className="text-xs text-gray-400">
              © 2025 Product Recommendation System Demo - Built with React, Tailwind CSS, and AI
            </p>
